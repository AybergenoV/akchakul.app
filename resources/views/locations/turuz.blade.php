                ...
                <div class="tour-main">
                    ...
                    <ul class="sayohat-dispr">
                        ...
                        <li class="sayohat-kunlar">
                            <span>1-Kun</span>
                            <span>
                                -Urganch-Istanbul Havo Qatnovi. Antaliya-Istanbul-Urganch<br>
                                -Aeroportda uchrashuv va simlarni o'tkazish <br>
                                -Ikki kishilik turar joy
 <br>
                                -4-5 toifadagi mehmonxonalarda turar joy <br>
                                -Nonushta asosida ovqatlanish(bufet)
<br>
                                -Marshrut bo'ylab transferlar

 <br>
 -Ekskursiyalar <br>
 -Sultanahmet maydoni va masjidi
<br>
-Moviy masjid. Sofiya sobori va To'pqopi saroyi
<br>
-Hippodrome (nemis favvorasi, Misr Obelisk, ilon ustuni, Konstantin Obelisk)
<br>
-Troyan otiga tashrif buyurish <br>
-Qadimgi Troya shahri safari
<br>
-Qadimgi Efes shahri safari
<br>
-Karpuzkaldiran Palapartishlik <br>
-Antaliyaning Markaziy maydoni
<br>
-Panoramik maydoni
<br>
-Tibbiy sug'urta
<br>
-Tur davomida rus tilida qo'llanma hamrohlik
